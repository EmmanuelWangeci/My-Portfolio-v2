...
const TECH_STACK = ["React", "Javascript", "Next.Js", "Figma"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/EmmanuelWangeci" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/emmanuel-wangeci-73626b28b/" },
  { icon: Instagram, link: "https://www.instagram.com/emmanuel_wangeci/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Crafting modern, high-performing websites that captivate, convert, and enhance user experiences effortlessly.
                </p>
