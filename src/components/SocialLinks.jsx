...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/emmanuel-wangeci-73626b28b/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@emmanuel_wangeci",
    icon: Instagram,
    url: "https://www.instagram.com/emmanuel_wangeci/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@BrandBoulevard-24",
    icon: Youtube,
    url: "https://www.youtube.com/@BrandBoulevard-24",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@EmmanuelWangeci",
    icon: Github,
    url: "https://github.com/EmmanuelWangeci",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@its_emmanuelw",
    color: "black",
